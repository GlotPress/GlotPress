...
function gp_register_default_styles() {
	...
	wp_register_style( 'gp-base', $url . '/style' . $suffix, array(), '20200425' );
...
function gp_register_default_scripts() {
	...
	wp_register_script( 'gp-editor', $url . '/editor' . $suffix, array( 'gp-common', 'jquery-ui-tooltip' ), '20200424' );
	wp_register_script( 'gp-glossary', $url . '/glossary' . $suffix, array( 'gp-editor' ), '20160329' );
	wp_register_script( 'gp-translations-page', $url . '/translations-page' . $suffix, array( 'gp-editor' ), '20200424' );
