...
function gp_register_default_styles() {
	...
	wp_register_style( 'driver-js', 'https://cdn.jsdelivr.net/npm/driver.js@1.0.1/dist/driver.css', array(), '1.0.1' );
}
...
function gp_register_default_scripts() {
	...
	wp_register_script( 'driver-js', 'https://cdn.jsdelivr.net/npm/driver.js@1.0.1/dist/driver.js.iife.js', array(), '1.0.1' );
