...
function gp_register_default_styles() {
	...
	wp_register_style( 'gp-base', $url . '/style' . $suffix, array(), '20220313' );
...
function gp_register_default_scripts() {
	...
	wp_register_script( 'gp-common', $url . '/common' . $suffix, array( 'jquery' ), '20210429' );
	...
	wp_register_script( 'gp-editor', $url . '/editor' . $suffix, array( 'gp-common', 'jquery-ui-tooltip' ), '20220313' );
	wp_register_script( 'gp-glossary', $url . '/glossary' . $suffix, array( 'gp-editor' ), '20210429' );
	wp_register_script( 'gp-translations-page', $url . '/translations-page' . $suffix, array( 'gp-editor' ), '20210429' );
