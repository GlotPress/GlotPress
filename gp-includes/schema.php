...
function gp_schema_get() {
	...
	*/
	$gp_schema['translations'] = "CREATE TABLE $gpdb->translations (
	...
	*/
	$gp_schema['translation_sets'] = "CREATE TABLE $gpdb->translation_sets (
		id INT(10) NOT NULL auto_increment,
	 ...
	 */
	$gp_schema['originals'] = "CREATE TABLE $gpdb->originals (
		id INT(10) NOT NULL auto_increment,
		project_id INT(10) DEFAULT NULL,
	...
	Glossary Entries
	*/
	$gp_schema['glossary_entries'] = "CREATE TABLE $gpdb->glossary_entries (
	...
	Glossaries
	*/
	$gp_schema['glossaries'] = "CREATE TABLE $gpdb->glossaries (
		id INT(10) unsigned NOT NULL auto_increment,
	...
	*/
	$gp_schema['projects'] = "CREATE TABLE $gpdb->projects (
		id INT(10) NOT NULL auto_increment,
		name VARCHAR(255) NOT NULL,
		slug VARCHAR(255) NOT NULL,
	...
	// meta
	$gp_schema['meta'] = "CREATE TABLE $gpdb->meta (
	...
	// permissions
	$gp_schema['permissions'] = "CREATE TABLE $gpdb->permissions (
		id INT(10) NOT NULL AUTO_INCREMENT,
		user_id INT(10) DEFAULT NULL,
	...
	// API keys
	$gp_schema['api_keys'] = "CREATE TABLE $gpdb->api_keys (
		id INT(10) NOT NULL AUTO_INCREMENT,
