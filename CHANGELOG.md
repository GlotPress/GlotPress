...
* New: Add CONTRIBUTING.md ([#216](https://github.com/GlotPress/GlotPress-WP/issues/216))
* New: Support GitHub directory ([#283](https://github.com/GlotPress/GlotPress-WP/issues/283))
...
* New: Use wp-dev-lib for development ([#320](https://github.com/GlotPress/GlotPress-WP/issues/320))
...
* Bugfix: Tests: Remove unnecessary filters for `gp_set_cookie` ([#287](https://github.com/GlotPress/GlotPress-WP/issues/287))
...
* Delete: Remove composer from unit tests ([#251](https://github.com/GlotPress/GlotPress-WP/pull/251))
