...
<dl>
	...
	<dd>
		...
		<?php if ( ! ( ( 'changes_requested' == $translation->translation_status ) && ( ! apply_filters( 'gp_enable_changes_requested_status', false ) ) ) ) : // todo: delete when we merge the gp-translation-helpers in GlotPress. ?>
